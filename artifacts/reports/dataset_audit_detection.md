...
- **Genere le** : 2026-07-30T10:01:40.524690+00:00
...
> **Verdict : PRET POUR LA DETECTION** — 7000 images, 25542 annotations, 0 ligne(s) polygonale(s) a convertir, 0 erreur(s), 5 avertissement(s), 0 groupe(s) de doublons exacts.

## 1. Vue d'ensemble par split

| Split     | Images | Labels | Annot. | Detection | Polygone | Malformees | Appariement | Taille   |
|-----------|--------|--------|--------|-----------|----------|------------|-------------|----------|
| train     | 4903   | 4903   | 17873  | 17873     | 0        | 0          | oui         | 606.5 Mo |
| valid     | 1399   | 1399   | 5197   | 5197      | 0        | 0          | oui         | 168.1 Mo |
| test      | 698    | 698    | 2472   | 2472      | 0        | 0          | oui         | 82.6 Mo  |
...
| valid | 5197   | 1.157e-05  | 0.001718 | 0.021503 | 0.388689 | 0.97051  | 35.04 %              |
| test  | 2472   | 0.00026109 | 0.00149  | 0.02026  | 0.387974 | 0.970368 | 36.57 %              |
...
|----------|-------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AVERT.   | clamped_minor                 | [train] 246 boite(s) corrigee(s) : clamped_minor.                                                                                                                                              |
| AVERT.   | clamped_minor                 | [valid] 74 boite(s) corrigee(s) : clamped_minor.                                                                                                                                               |
